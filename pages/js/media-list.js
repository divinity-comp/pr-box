...
function wooPitchSearch(num) {
    ...
    var wooJs = {skip:skipSearch,addurl:"/SearchProfiles/ExternalSearchProfiles"};
    ...
    ajaxRequestToMake(urlInit + "/app/"+ appVersion + "/woopitch/woo-pitch-data-get",
        ...
        if(responseJson.items.length == 0) {
            ...
            for(i=0;i < responseJson.items.length;i++) (function(i){
                ...
                clondSI.children[2].children[0].href = responseJson.items[i].linkedInUrl;
                clondSI.children[2].children[0].innerHTML = responseJson.items[i].name;
                clondSI.children[2].innerHTML += "<br>" + responseJson.items[i].description;
                clondSI.children[3].children[0].href = responseJson.items[i].googleSearchLink;
...
function fulltoggleActive(ele) {
    ...
    for(i=0;i<icheckboxsquare.length;i++) { icheckboxsquare[i].setAttribute("active",ele.getAttribute("active"));
    }
}
        ...
        if(!hasSelected) {
            ...
            for(i = 1;i < fullML.length; i++) {
                ...
                for(b = 0; b < 11;b++) {
                    ...
                    var csvEleP3 = document.createElement("td");csvEleP3.setAttribute("contenteditable","true");
                    csvEleP3.innerHTML = "";
                    if(b == 0) {
